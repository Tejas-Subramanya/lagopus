...
#define OXM_OF_GTPU_FLAGS   OXM_HEADER  (0x800, OFPXMT_OFB_GTPU_FLAGS, 1)
#define OXM_OF_GTPU_VER   OXM_HEADER  (0X800, OFPXMT_OFB_GTPU_VER, 1)
#define OXM_OF_GTPU_MSGTYPE   OXM_HEADER  (0X800, OFPXMT_OFB_GTPU_MSGTYPE, 1)
#define OXM_OF_GTPU_TEID   OXM_HEADER  (0X800, OFPXMT_OFB_GTPU_TEID, 4)
